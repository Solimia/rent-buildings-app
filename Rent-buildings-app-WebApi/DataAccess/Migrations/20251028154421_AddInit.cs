    ...
    public partial class AddInit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "123 Country Lane", 80.0, new TimeSpan(0, 14, 0, 0, 0), new TimeSpan(0, 12, 0, 0, 0), "Kyiv", "Ukraine", 200m, "A small cozy house in the countryside.", false, true, false, true, true, true, true, false, 4, 1, null, 1000m, 50m, 4.5, 3, null, "Cozy Cottage", "Water, electricity, internet", true },
                    { 2, "45 Main Street", 60.0, new TimeSpan(0, 0, 0, 0, 0), new TimeSpan(0, 0, 0, 0, 0), "Lviv", "Ukraine", null, "A modern apartment in the city center.", true, false, false, true, false, false, true, false, 3, null, null, null, 70m, 0.0, 2, null, "Modern Apartment", null, false }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "https://filesblog.technavio.org/wp-content/uploads/2018/12/Online-House-Rental-Sites.jpg" },
                    { 2, 1, "https://filesblog.technavio.org/wp-content/uploads/2018/12/Online-House-Rental-Sites.jpg" },
                    { 3, 2, "https://filesblog.technavio.org/wp-content/uploads/2018/12/Online-House-Rental-Sites.jpg" }
                });
